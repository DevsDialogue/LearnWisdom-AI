      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center md:space-y-0 space-y-6">
          ...
          <div className="text-center md:text-left md:w-1/3 space-y-1">
            <h2 className="font-extrabold text-lg tracking-wider text-black dark:text-white">LearnWisdom AI</h2>
            <p className="text-black dark:text-white text-xs">Your gateway to quality education</p>
            <p className="text-black dark:text-white text-xs">Empowering learners everywhere</p>
          </div>

          {/* Contributors Section */}
          <div className="w-full md:w-1/3 text-center">
            <h3 className="text-lg font-semibold mb-2 text-black dark:text-white">Contributors</h3>
            <People />
          </div>
